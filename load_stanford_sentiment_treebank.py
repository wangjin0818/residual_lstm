...
corpus_path = os.path.join('corpus', 'stanford_sentiment_treebank')
...
if __name__ == '__main__':
    ...
    logging.info("loading #sentiment label")
    sentiment_file = open(os.path.join(corpus_path, 'sentiment_labels.txt'), 'r')
    sentiment_label = {}
    n = 0
